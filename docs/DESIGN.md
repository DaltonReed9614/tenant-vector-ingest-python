...
> Design notes for **tenant-vector-ingest-python** — a runnable python example that Typed tenant document chunking and vector ingestion service.
...
- **Feature code** — the actual task: tenant document ingest.
